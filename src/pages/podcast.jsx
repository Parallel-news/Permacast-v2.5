                ...
                <div className="ml-4 flex flex-col">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="mx-1.5 w-full line-clamp-1 text-xs">
                      Sintel, code-named Project Durian during production, is a
                      2010 computer-animated fantasy short film. It was the
                      third Blender "open movie". It was produced by Ton
                      Roosendaal, chairman of the Blender Foundation, written by
                      Esther Wouda, directed by Colin Levy, at the time an
                      artist at Pixar and art direction by David Revoy, who is
                      known for Pepper&Carrot an open source webcomic series.
                    </div>
                  </div>
                </div>
              </div>
