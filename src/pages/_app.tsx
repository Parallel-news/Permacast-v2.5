...
const ArconnectProvider = React.lazy(() =>
  import("react-arconnect").then((module) => ({
    default: module.ArconnectProvider,
  }))
);
const Layout = React.lazy(() => import("@/component/layout"));
const QueryAns = React.lazy(() =>
  import("@/features/prefetching").then((module) => ({
    default: module.QueryAns,
  }))
);
const QueryPodcasts = React.lazy(() =>
  import("@/features/prefetching").then((module) => ({
    default: module.QueryPodcasts,
  }))
);
const RecoilRoot = React.lazy(() =>
  import("recoil").then((module) => ({ default: module.RecoilRoot }))
);
const ShikwasaProviderLazy = React.lazy(() =>
  import("@/hooks/useShikwasa").then((module) => ({
    default: module.ShikwasaProvider,
  }))
);
  ...
  return (
    <RecoilRoot>
      <Head>
        ...
        <meta
          name="description"
          content={`Permanent podcasting on Arweave. Pay once, store forever.`}
        />
        <meta name="twitter:card" content="summary"></meta>
        <meta
          name="twitter:image"
          content={`https://permacast.app/favicon.ico`}
        />
