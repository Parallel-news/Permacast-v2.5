...
export function FeaturedVideoShows({videoShows}) {
  ...
  return (
    <div className="carousel">
      ...
      <div className={`carousel-item max-w-[280px] md:max-w-xs pr-4`}>
        
      <>
      <div style={{backgroundColor: 'blue', color: 'white'}} className="mt-4 backdrop-blur-md rounded-3xl cursor-pointer" onClick={() => {
            setVS_(['more', {}])
          }}>
        <div className="h-1/6 w-full px-5 pb-2 cursor-pointer" onClick={() => {
            setVS_(['more', {}])
          }}>
          {/* <div onClick={() => {
            setVS_(['more', {}])
