...
export const borderCreatorStyling = `flex justify-between items-center p-4 mb-4 w-full border-zinc-800 border rounded-3xl `;
        ...
        <div className={borderCreatorStyling}>
          <div className={flexCenter}>
            {(({ currentLabel, avatar, address_color }) => 
              <ProfileImage {...{currentLabel, avatar, address_color, size: 48}} />)
            (creator)}
