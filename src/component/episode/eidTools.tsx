...
export const episodeInfoStyling = "flex flex-col justify-center items-center space-y-4 px-10"
...
export const episodeTitleStyling = "text-[40px] font-medium pb-0 flex items-end text-center lg:text-start"
