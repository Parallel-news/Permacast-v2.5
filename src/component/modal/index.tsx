...
import { ConnectButton, containerPodcastModalStyling, SelectPodcastModal, SubmitTipButton, tipModalStyling } from "../uploadEpisode/uploadEpisodeTools";
...
const Modal: FC<TipModalInter> = (props) => {
    ...
    return (
        <div className={tipModalStyling+" backdrop-blur-sm"}>
            <div className={`${containerPodcastModalStyling+ " justify-between relative overflow-hidden"} ${showModal ? FADE_IN_STYLE :FADE_OUT_STYLE}`}>
                ...
                {showModalisVisible &&
                  <SelectPodcastModal 
                      isVisible={showModalisVisible}
                      setVisible={setShowModalIsVisible}
                      setPid={setPid}
                      shows={yourShows}
                  />
                }
